...
Six phases, in the order I actually work through them for a new system.
...
1. [Defining the User, the MVP, and the Critical Path](/defining-users-mvp-and-critical-path). before code, define what you are building.
2. [Defining the Workload Before Writing Code](/defining-the-workload). architecture is a response to workload, not a taste preference.
3. [First-Order Architecture](/first-order-architecture-decisions). monolith vs services vs serverless, monorepo vs polyrepo, framework family.
4. [The Junior Trap and the Senior Trap](/junior-trap-senior-trap). how AI damages different seniority levels differently, and what juniors should do about it.
...
6. [Designing for Resiliency and Failure Modes](/designing-for-resiliency)
7. [Real-World Resilience with BullMQ, Downstream Outages, and Cross-Team Contract Drift](/real-world-resilience-bullmq-and-contracts)
8. [Cloud Run, Cloud Armor, and the Two Infra Changes That Took Down My App](/cloud-run-cloud-armor-incident)
9. [Observability From Day One, Because You Cannot Debug What You Cannot See](/observability-from-day-one)

**Phase 4: Standards**

10. [Coding Standards and Automated Production Guardrails](/standards-and-guardrails)
11. [Duplicated Functions and Technical Debt You Can Actually Pay Off](/duplication-and-technical-debt)

**Phase 5: AI Discipline**

12. [The AI Co-Pilot Discipline, Myths, Facts, and the Blind-Paste Antipattern](/ai-copilot-discipline)
13. [Vibe Coding, Autopsy of an Incident That Should Not Have Happened](/vibe-coding-autopsy)
14. [The Junior Trap and the Senior Trap, How AI Damages Different Careers Differently](/junior-trap-senior-trap)
15. [Seven Engineering Tasks Where AI Is Worse Than Useless](/what-ai-is-worse-than-useless-at)
16. [The Agentic Development Workflow That Actually Ships Code](/agentic-development-workflow)

**Phase 6: Working Practices**

17. [What I Actually Look for in a Code Review](/code-review-what-i-look-for)
18. [What I Look for When I Hire an Engineer, and What Interviews Should Look Like in the AI Era](/hiring-engineers-what-i-look-for)

## What Is Coming

Topics under active work for future posts, in rough order:

- **Auth and identity**. session vs JWT, OAuth flows, refresh rotation, common leak patterns.
- **API design and versioning**. backward compatibility, deprecation windows, and how versioning intersects with contract testing.
- **Caching strategy end-to-end**. keys, TTLs, invalidation, stale-while-revalidate, thundering herd.
- **Environments and deployment strategies**. dev / staging / preview / prod, blue-green, canary, feature flags.

If any of these should jump the queue, [open a discussion](https://github.com/balangyaoejuspher/how-i-build/discussions) or reach out.
